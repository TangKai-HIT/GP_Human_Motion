function M=skelPlayData_m1(skelStruct, channels, frameLength, color, linestyle)
...
% modified: use getframe() to make animation
...
ValueArray = {color, linestyle};
set(handle(2:end), NameArray, ValueArray);
